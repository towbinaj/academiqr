      ...
      <div class="public-frame" style="${c}">
        <div class="public-screen" style="${l}">
          ...
          <div class="public-links">
            ...
            `:t.map(r=>{const s=U(r),u=z(r),_=X(s.x,s.y,u),$=H(r),R=N(r)||"Untitled";return`
